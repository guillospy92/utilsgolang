...
func (x *PerProduct) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PerProduct) ProtoMessage() {}

func (x *PerProduct) ProtoReflect() protoreflect.Message {
	mi := &file_protos_product_proto_msgTypes[0]
...
// Deprecated: Use PerProduct.ProtoReflect.Descriptor instead.
func (*PerProduct) Descriptor() ([]byte, []int) {
	return file_protos_product_proto_rawDescGZIP(), []int{0}
}

func (x *PerProduct) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *PerProduct) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PerProduct) GetPrice() float64 {
	if x != nil {
		return x.Price
	}
	return 0
...
type CreateProductResponse struct {
	...
	Product *PerProduct `protobuf:"bytes,1,opt,name=product,proto3" json:"product,omitempty"`
}
...
func (x *CreateProductResponse) GetProduct() *PerProduct {
	if x != nil {
		return x.Product
	}
	return nil
...
func (x *CreateProductRequest) GetProduct() *PerProduct {
	if x != nil {
		return x.Product
	}
	return nil
...
var file_protos_product_proto_rawDesc = []byte{
	...
	0x46, 0x0a, 0x0a, 0x50, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x12, 0x0e, 0x0a,
	...
	0x0b, 0x32, 0x13, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x50, 0x65, 0x72, 0x50,
	...
	0x63, 0x74, 0x2e, 0x50, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x07, 0x70,
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x32, 0x60, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x15, 0x5a, 0x13, 0x70, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x74, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x5f, 0x70, 0x62, 0x62,
...
var file_protos_product_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_protos_product_proto_goTypes = []interface{}{
	(*PerProduct)(nil),            // 0: product.PerProduct
...
var file_protos_product_proto_depIdxs = []int32{
	0, // 0: product.CreateProductResponse.product:type_name -> product.PerProduct
	0, // 1: product.CreateProductRequest.product:type_name -> product.PerProduct
